...
namespace DICOMViews
{
    ...
    public class VolumeSettingsPanel : MonoBehaviour
    {
        ...
        [SerializeField] private UISliderController _intensitySlider = null;
        [SerializeField] private UISliderController _opacitySlider = null;
        [SerializeField] private UISliderController _stepCountSlider = null;

        [SerializeField] private GameObject _rotationObject = null;

        [SerializeField] private UISliderController _maxSlider = null;
        [SerializeField] private UISliderController _minSlider = null;
        ...
        public void IntensityChanged(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void OpacityChanged(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void StepCountChanged(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void OnMinChanged(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void OnMaxChanged(UISliderController tubeSlider)
        {
            switch (_currentConfig)
            {
                case CullAxis.X:
