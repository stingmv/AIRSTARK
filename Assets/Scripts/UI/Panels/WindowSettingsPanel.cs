...
namespace DICOMViews
{
    ...
    {
        public TMP_Dropdown DefaultSettings;

        public UISliderController WidthSlider;
        public UISliderController CenterSlider;
        ...
        private void Start()
        {
            WidthSlider.SliderChangedEvent.AddListener(delegate(UISliderController tubeSlider)
            {
                WindowWidth = tubeSlider.CurrentInt;
                OnSettingsChangedEvent.Invoke(WindowWidth, WindowCenter);          
            });

            CenterSlider.SliderChangedEvent.AddListener(delegate(UISliderController tubeSlider)
            {
