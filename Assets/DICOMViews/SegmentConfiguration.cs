...
namespace DICOMViews
{
    ...
    public class SegmentConfiguration : MonoBehaviour
    {
        ...
        [SerializeField] private TMP_Dropdown _segmentationStrategyChoice;

        [SerializeField] private GameObject _rangeParent;
        [SerializeField] private UISliderController _minRange;
        [SerializeField] private UISliderController _maxRange;

        [SerializeField] private GameObject _regionGrowParent;
        [SerializeField] private TMP_Text _seedXRegion;
        [SerializeField] private TMP_Text _seedYRegion;
        [SerializeField] private TMP_Text _seedZRegion;
        [SerializeField] private UISliderController _thresholdRegion;
        ...
        public void UpdateThreshold(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void UpdateRegionMin(UISliderController tubeSlider)
        {
        ...
        /// </summary>
        /// <param name="tubeSlider"></param>
        public void UpdateRegionMax(UISliderController tubeSlider)
        {
            if (_rangeParameters[_selectedSegment] != null)
            {
